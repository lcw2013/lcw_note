...
我们这里以比较核心的订单系统为例
![](assets/05-垃圾收集器ParNew&CMS与底层三色标记算法详解/file-20260412175746410.png)
...
![](assets/05-垃圾收集器ParNew&CMS与底层三色标记算法详解/file-20260412175903544.png)
...
![](assets/05-垃圾收集器ParNew&CMS与底层三色标记算法详解/file-20260412180930959.png)
```java
/**
 * 垃圾收集算法细节之三色标记
...
```
针对第一步：D d = a.b.d，当读取成员变量时，一律记录下来：
```java
...
![](assets/05-垃圾收集器ParNew&CMS与底层三色标记算法详解/file-20260412182818624.png)
